...
if not on_rtd:
    # Add the menpodetect root so we can grab the version
    sys.path.insert(0, os.path.abspath("../../"))
...
version = menpodetect.__version__
# The full version, including alpha/beta/rc tags.
release = menpodetect.__version__
...
latex_documents = [
    ("index", "Menpo.tex", u"Menpo Documentation", authors, "manual"),
]
...
man_pages = [("index", "menpodetect", u"MenpoDetect Documentation", [authors], 1)]
